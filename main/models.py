...
class Section(models.Model):
    departament = models.ForeignKey(Departament, on_delete=models.CASCADE, verbose_name='Цех',
...
class Phone(models.Model):
    ...
    home_vnut = models.CharField(max_length=255, verbose_name='Домашний внутренний номер', null=True, blank=True)

    home_41 = models.CharField(max_length=255, verbose_name='Домашний сотовый номер 1', null=True, blank=True)
    home_42 = models.CharField(max_length=255, verbose_name='Домашний сотовый номер 2', null=True, blank=True)
    home_43 = models.CharField(max_length=255, verbose_name='Домашний сотовый номер 3', null=True, blank=True)
