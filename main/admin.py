...
class DepartamentAdmin(admin.ModelAdmin):
    list_display = ['name']
    list_filter = ['name']
    fields = ('name', 'number', 'nickname_1', 'nickname_2', 'nickname_3', 'nickname_4', 'nickname_5', 'nickname_6', 'nickname_7',
...
class PhoneAdmin(admin.ModelAdmin):
    ...
    fields = ('FIO', 'job_title', 'section', 'number_1', 'is_active_vnut_number', 'number_21', 'number_22', 'number_23',
              'is_active_gorod_number', 'number_31', 'number_32', 'number_33')
